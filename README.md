...
**06_MDS_SITES.R**
Reads in compiled Flux data, ERA5 data, MODIS data for all sites, creates a distance matrix, multidimensional scaling and visualizes the dissimilarity between sites. Explore potential approaches for scaling model results. 
