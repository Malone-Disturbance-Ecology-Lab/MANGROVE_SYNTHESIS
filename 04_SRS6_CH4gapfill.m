...
%%%%%%%%%%%%%%%%%%%%%%% read in FLUX data
flux_data = readtable('C:\Users\der66\Dropbox (YSE)\Yale\FCE projects\mangrove multisite\NEE_gapfilled_data_SRS6.csv','VariableNamingRule','preserve',"TreatAsMissing","NA");
...
%%%%%%%%%%%%%%%%%%%%%%% inputs for RF model
X_input_CH4_complex = table(flux_data_30min.NEE_gf,model_input_flux.TA_gf,model_input_flux.TS_gf,model_input_flux.WS,model_input_flux.Turb,model_input_flux.VPD_gf,model_input_flux.NetRad,DOY.DOY,MODIS_data_30min.NDVI,model_input_flux.P_gf_runningsum,'VariableNames',["NEE","TA","TS","WS","Turb","VPD","NetRad","DOY","NDVI","P"]);
...
%figure
hold on
plot(flux_data_30min.NEECH4_ut)
...
flux_data.NEECH4_gf = flux_data.NEECH4_ut;
...
%writetimetable(flux_data,'CH4_NEE_gapfilled_data_SRS6.csv')
